...
select nome, endereco, telefone, codPedido, quantidade, valorTotal, dia, status, codEntregador
from Delivery.Cliente JOIN Delivery.Pedido on Delivery.Pedido.codPedido = Delivery.Cliente.codCliente 
where status = 0;